...
def write_config():
     with open('sa3_europe.cfg', 'w') as config:
        config.write("\n".join(lines))

def test():
    return os.system("./gbadisasm sa3_europe.gba -c sa3_europe.cfg > sa3_europe.s")

with open('sa3_europe_functions.csv') as functions_file:
